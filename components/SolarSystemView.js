...
const SOLAR_SYSTEM_CONFIG = {
  ...
  planets: [
    ...
    },
    {
      ...
      initialAngle: 270,
      hasAtmosphere: true,
      atmosphereColor: 'rgba(135, 206, 235, 0.2)',
      tilt: 98,
      moons: [
        { size: 2, distance: 30, speed: 15000, color: '#E6E6FA' }, // Miranda
        { size: 2.5, distance: 40, speed: 20000, color: '#F0F8FF' }, // Ariel
      ],
    },
    {
      value: 128, // Neptune
      ...
      initialAngle: 315,
      hasAtmosphere: true,
      atmosphereColor: 'rgba(30, 144, 255, 0.25)',
      moons: [
        { size: 2, distance: 35, speed: 18000, color: '#E6E6FA' }, // Triton
      ],
    },
  ],
  dwarfPlanets: [
    ...
    {
      value: 4, // Moon (as dwarf planet for display)
      size: 8,
      orbitRadius: 450,
      orbitSpeed: 220000,
      initialAngle: 60,
...
const SolarSystemView = ({ opacity = 0.5, scale = 0.8 }) => {
  return (
    <View style={{
      position: 'absolute',
      width: '100%',
